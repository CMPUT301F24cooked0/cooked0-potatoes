...
public class FacilityUnitTest {
    ...
    public void addEventTest() throws Exception {
        ...
        String address = "address";
        Facility facility = new Facility("name", location, address);
        Event event = new EventMock("name", Instant.parse("2025-01-01T00:00:00.00Z"), Instant.parse("2025-01-01T01:00:00.00Z"), Instant.parse("2025-01-01T00:00:00.00Z"), Instant.parse("2025-01-01T01:00:00.00Z"), null, false);
