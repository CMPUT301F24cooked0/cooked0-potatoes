...
public class EventUnitTest {
    ...
    public void firstConstructorTest() throws Exception {
        Event event = new EventMock("name", Instant.parse("2025-01-01 00:00:00"), null);
    }

    @Test
    public void secondConstructorTest() throws Exception {
        Event event = new EventMock("name", Instant.parse("2025-01-01 00:00:00"), null, 123);
    }
    ...
    public void setGetDateTest() throws Exception {
        ...
        Instant instant = Instant.parse("2026-01-01 00:00:00");
