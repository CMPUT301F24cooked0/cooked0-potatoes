...
public class EventUnitTest {
    ...
    public void firstConstructorTest() throws Exception {
        Event event = new EventMock("name", Instant.parse("2025-01-01T00:00:00.00Z"), Instant.parse("2025-01-01T01:00:00.00Z"), null, false);
    }

    @Test
    public void secondConstructorTest() throws Exception {
        Event event = new EventMock("name", Instant.parse("2025-01-01T00:00:00.00Z"), Instant.parse("2025-01-01T01:00:00.00Z"), null, 123, false);
    }
    ...
    public void setGetDateTest() throws Exception {
        Event event = new EventMock("name", Instant.parse("2025-01-01T00:00:00.00Z"), Instant.parse("2027-01-01T01:00:00.00Z"), null, false);
